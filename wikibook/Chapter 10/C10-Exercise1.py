#!/usr/bin/env python3
# ~*~ coding: utf-8 ~*~
# Expand the test.py pogram so it has a menu giving the option of taking the
# test, viewing the list of questions and answers, and an option to quit. Also,
# add a new question to ask, "What noise does a truly advanced machine
# make?" with the answer of "ping."
