...
def main():
    ...
    # Hint: Check page 279
    from pythontutorials.books.CrackingCodes.Chapter20.vigenereDictionaryHacker import hackVigenereDictionary
    ...
    from pythontutorials.books.CrackingCodes.Chapter20.vigenereHacker import hackVigenere
