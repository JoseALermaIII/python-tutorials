...
from pythontutorials.books.CrackingCodes.Chapter11.detectEnglish import isEnglish
...
def hackVigenereDictionary(ciphertext: str):
    ...
    English with the :func:`~books.CrackingCodes.Chapter11.detectEnglish.isEnglish` module, and prompts user
