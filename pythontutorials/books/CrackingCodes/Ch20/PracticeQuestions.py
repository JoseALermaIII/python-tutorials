...
def main():
    ...
    # Hint: Check page 279
    from pythontutorials.books.CrackingCodes.Ch20.vigenereDictionaryHacker import hackVigenereDictionary
    ...
    from pythontutorials.books.CrackingCodes.Ch20.vigenereHacker import hackVigenere
