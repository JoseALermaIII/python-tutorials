...
from pythontutorials.books.CrackingCodes.Chapter01.caesarCipher import decryptMessage, encryptMessage
from pythontutorials.books.CrackingCodes.Chapter01.caesarHacker import hackCaesar
import pythontutorials.books.CrackingCodes.Chapter01.constants


def main():
    # Every possible symbol that can be encrypted (if encrypting by hand):
    pythontutorials.books.CrackingCodes.Chapter01.constants.SYMBOLS = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'
