...
Creates :py:mod:`CrackingCodes.Chapter17.wordPatterns` based on the words in our dictionary text file,
...
DICTIONARY_FILE = '/home/jose/PycharmProjects/python-tutorials/pythontutorials/books/CrackingCodes/Chapter11/dictionary.txt'
...
def getWordPattern(word: str) -> str:
    ...
    Example:
    >>> import pythontutorials.books.CrackingCodes.Chapter17.makeWordPatterns as makeWordPatterns
