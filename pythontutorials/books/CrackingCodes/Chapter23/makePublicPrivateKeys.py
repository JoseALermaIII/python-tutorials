...
from pythontutorials.books.CrackingCodes.Chapter13.cryptomath import gcd, findModInverse
from pythontutorials.books.CrackingCodes.Chapter22.primeNum import generateLargePrime
