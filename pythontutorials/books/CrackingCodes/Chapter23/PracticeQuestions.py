...
def main():
    ...
    import pythontutorials.books.CrackingCodes.Chapter01.caesarCipher
    ...
    #print(books.CrackingCodes.Chapter01.caesarCipher.decryptMessage(blank, blank))  # Fill in the blanks
    #print(books.CrackingCodes.Chapter01.caesarCipher.decryptMessage(blank, blank))
    #print(books.CrackingCodes.Chapter01.caesarCipher.decryptMessage(blank, blank))

    # 4. What is non-repudiation?
    # Hint: Check page 339
    # Don't do this - imports should be at the top of the file
    import pythontutorials.books.CrackingCodes.Chapter20.vigenereDictionaryHacker
    ...
    #print(books.CrackingCodes.Chapter20.vigenereDictionaryHacker.hackVigenereDictionary(blank))  # Fill in the blank
