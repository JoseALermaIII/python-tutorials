...
Creates :py:mod:`CrackingCodes.Ch17.wordPatterns` based on the words in our dictionary text file,
...
def getWordPattern(word: str) -> str:
    ...
    Example:
    >>> import pythontutorials.books.CrackingCodes.Ch17.makeWordPatterns as makeWordPatterns
