...
from pythontutorials.books.CrackingCodes.Ch01.caesarCipher import decryptMessage, encryptMessage
from pythontutorials.books.CrackingCodes.Ch01.caesarHacker import hackCaesar
import pythontutorials.books.CrackingCodes.Ch01.constants


def main():
    # Every possible symbol that can be encrypted (if encrypting by hand):
    pythontutorials.books.CrackingCodes.Ch01.constants.SYMBOLS = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'
