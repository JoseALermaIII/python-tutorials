...
import pythontutorials.books.CrackingCodesWithPython.Chapter01


def main():
    # Every possible symbol that can be encrypted (if encrypting by hand):
    pythontutorials.books.CrackingCodesWithPython.Chapter01.SYMBOLS = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'
